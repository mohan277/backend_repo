...
from source_code_dependency_example.employees.business_developer import BusinessDeveloper

class PayoutCalculator:

    @classmethod
    def calculate_payout(cls, employees: List[Union[Developer, Designer, BusinessDeveloper]]):
        total_payout = 0
